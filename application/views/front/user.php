<!--  -->
<script src="<?php echo base_url().'style/bootstrap/js/jquery.min.js';?>"></script>
<!-- kindeditor -->
<link rel="stylesheet" href="<?=base_url()?>style/editor/themes/post/post.css" />
<script charset="utf-8" src="../style/editor/kindeditor.js"></script>
<script charset="utf-8" src="../style/editor/lang/zh_CN.js"></script>
<!-- tagsinput -->
<link rel="stylesheet" href="<?=base_url()?>style/tags-input/jquery.tagsinput.css" />
<script charset="utf-8" src="<?=base_url()?>style/tags-input/jquery.tagsinput.js"></script>
<script>
...
<div class="container post-edit">
	<form class="post" action="<?=base_url().'index.php/user/submit_post'?>" role="form" method="post" enctype="multipart/form-data">
		<!-- title -->
		<input type="text" name="title" class="form-control title" placeholder="<?=$input_title?>">
		<!-- description -->
