...
<div class=" container mainpart">
	<span class="title" style="color:rgb(255, 154, 0)"><?php echo $video?></span>
	<span class="download-btn">
		<a href="<?php echo site_url('/user?manage=vshare&act=post_new'); ?>" class="btn btn-primary"><?php echo $upload_file; ?></a>
	</span>
	<table class="table table-hover table-bordered table-striped video-list">
		<tr>
		...
		<tr>
			<td>
				<a href="<?php echo base_url('index.php/video/id/'.$posts[$i]['torrent_id']); ?>">
					<?php 
