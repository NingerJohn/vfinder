...
<div class="container book">
	<a name="rating-box"></a>
	<h3 style="color:rgb(255, 154, 0)"><?php echo $book?></h3>
	...
	<div class="container book-info">
		...
		<div class="sub-info-row title">
			<?php echo $book_name.$colon.$info['title']; ?>
		</div>
		...
		<div class="sub-info-row download-link">
			<a href="<?php echo site_url('book/download_torrent').'/'.$info['torrent_id']?>"class="btn btn-primary download"><?php echo $download; ?></a>
		</div>
...
<script type="text/javascript">
	...
	$('input.add-comment-btn').click(function(){
		...
		var url = '<?php echo site_url("book/login_check") ?>';
		...
		if(status=='true'){
			var type = "POST";
			//Needs to be modified
			var url = "<?php echo site_url('book/add_comment/') ?>";
	...
	$('a.up-btn').click(function(){
		...
		if (result === "true") {
			...
			//alert(rate);
			var type = 'POST';
			var url = '<?php echo site_url("book/rating"); ?>';
