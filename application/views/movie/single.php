...
<div class="container movie">
	...
	<div class="container movie-info">
		...
		<div class="sub-info-row title">
			<?php echo $movie_name.$colon.$info['title']; ?>
		</div>
		...
		<div class="sub-info-row download-link">
			<a href="<?php echo site_url('movie/download_torrent').'/'.$info['torrent_id']?>"class="btn btn-primary download"><?php echo $download; ?></a>
		</div>
...
<script type="text/javascript">
	...
	$('input.add-comment-btn').click(function(){
		...
		var url = '<?php echo site_url("movie/login_check") ?>';
		...
		if(status=='true'){
			var type = "POST";
			//Needs to be modified
			var url = "<?php echo site_url('movie/add_comment/') ?>";
	...
	$('a.up-btn').click(function(){
		...
		if (result === "true") {
			...
			//alert(rate);
			var type = 'POST';
			var url = '<?php echo site_url("movie/rating"); ?>';
